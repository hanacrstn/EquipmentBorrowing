...
3. **Which project would eventually contain Avalonia Views?**
   A new UI project (ex. EquipmentBorrowing.Desktop) that references Application (to call
...
4. **Should an Avalonia button directly execute database queries? Why or why not?**
   ...
   untestable and unreusable from any other entry point (ex. a future API).
